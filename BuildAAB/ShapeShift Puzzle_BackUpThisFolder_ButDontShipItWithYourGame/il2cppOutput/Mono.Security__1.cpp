...
IL_000a:
	{
		Stream_tF844051B786E8F7F4244DBD218D74E8617B9A2DE* L_1 = __this->___fs;
		NullCheck(L_1);
		VirtualActionInvoker1< int64_t >::Invoke(11, L_1, ((int64_t)0));
...
IL_000f:
	...
	}
	{
		...
		NullCheck(L_4);
		VirtualActionInvoker1< int64_t >::Invoke(11, L_4, ((int64_t)((int32_t)il2cpp_codegen_add(L_5, 8))));
...
IL_000f:
	{
		...
		NullCheck(L_1);
		VirtualActionInvoker1< int64_t >::Invoke(11, L_1, ((int64_t)L_2));
		V_1 = 0;
...
IL_0126:
	{
		...
		NullCheck(L_31);
		int64_t L_32;
		L_32 = VirtualFuncInvoker0< int64_t >::Invoke(9, L_31);
...
IL_013e:
	{
		...
		NullCheck(L_35);
		int64_t L_36;
		L_36 = VirtualFuncInvoker0< int64_t >::Invoke(9, L_35);
